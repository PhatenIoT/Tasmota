...
const uint32_t HLW_PREF_PULSE = 10702;//12530;      // was 4975us = 201Hz = 1000W
const uint32_t HLW_UREF_PULSE = 1576;//1950;       // was 1666us = 600Hz = 220V
const uint32_t HLW_IREF_PULSE = 3702;//3500;       // was 1666us = 600Hz = 4.545A
