...
be_local_closure(Matter_Session_Store_save_fabrics,   /* name */
  be_nested_proto(
    ...
    /* K26  */  be_nested_str_weak(MTR_X3AReset_X20Open),
    /* K27  */  be_nested_str_weak(cmd),
    /* K28  */  be_nested_str_weak(MtrJoin_X3D1),
    /* K29  */  be_nested_str_weak(MTR_X3A_X20Saving_X20Fabrics_X20failed),
    /* K30  */  be_nested_str_weak(MTR_X3A_X20Session_Store_X3A_X3Asave_X20Exception_X3A),
    /* K31  */  be_nested_str_weak(_X7C),
    }),
    ...
    ( &(const binstruction[117]) {  /* code */
      ...
      0x1C180903,  //  0049  EQ	R6	R4	K3
      0x781A000D,  //  004A  JMPF	R6	#0059
      0x1C180703,  //  004B  EQ	R6	R3	K3
      0x781A000B,  //  004C  JMPF	R6	#0059
      0xB81A2800,  //  004D  GETNGBL	R6	K20
      0x8C180D15,  //  004E  GETMET	R6	R6	K21
      0x60200018,  //  004F  GETGBL	R8	G24
      0x5824001A,  //  0050  LDCONST	R9	K26
      0x7C200200,  //  0051  CALL	R8	1
      0x58240017,  //  0052  LDCONST	R9	K23
      0x7C180600,  //  0053  CALL	R6	3
      0xB81A2800,  //  0054  GETNGBL	R6	K20
      0x8C180D1B,  //  0055  GETMET	R6	R6	K27
      0x5820001C,  //  0056  LDCONST	R8	K28
      0x50240200,  //  0057  LDBOOL	R9	1	0
      0x7C180600,  //  0058  CALL	R6	3
      0x70020006,  //  0059  JMP		#0061
      0xB81A2800,  //  005A  GETNGBL	R6	K20
      0x8C180D15,  //  005B  GETMET	R6	R6	K21
      0x60200018,  //  005C  GETGBL	R8	G24
      0x5824001D,  //  005D  LDCONST	R9	K29
      0x7C200200,  //  005E  CALL	R8	1
      0x58240017,  //  005F  LDCONST	R9	K23
      0x7C180600,  //  0060  CALL	R6	3
      0xA8040001,  //  0061  EXBLK	1	1
      0x70020010,  //  0062  JMP		#0074
      0xAC0C0002,  //  0063  CATCH	R3	0	2
      0x7002000D,  //  0064  JMP		#0073
      0xB8162800,  //  0065  GETNGBL	R5	K20
      0x8C140B15,  //  0066  GETMET	R5	R5	K21
      0x601C0008,  //  0067  GETGBL	R7	G8
      0x5C200600,  //  0068  MOVE	R8	R3
      0x7C1C0200,  //  0069  CALL	R7	1
      0x001E3C07,  //  006A  ADD	R7	K30	R7
      0x001C0F1F,  //  006B  ADD	R7	R7	K31
      0x60200008,  //  006C  GETGBL	R8	G8
      0x5C240800,  //  006D  MOVE	R9	R4
      0x7C200200,  //  006E  CALL	R8	1
      0x001C0E08,  //  006F  ADD	R7	R7	R8
      0x58200017,  //  0070  LDCONST	R8	K23
      0x7C140600,  //  0071  CALL	R5	3
      0x70020000,  //  0072  JMP		#0074
      0xB0080000,  //  0073  RAISE	2	R0	R0
      0x80000000,  //  0074  RET	0
    })
