...
be_local_closure(Matter_UI_show_commissioning_info,   /* name */
  be_nested_proto(
    ...
    /* K13  */  be_nested_str_weak(MTR_Manual_Code_X3A_X20),
    ...
    ( &(const binstruction[63]) {  /* code */
      ...
      0x8C180306,  //  003B  GETMET	R6	R1	K6
      0x58200012,  //  003C  LDCONST	R8	K18
